        ...
        <header id="hero" data-track="hero" className="mb-20 print:mb-6 flex flex-col items-center text-center md:text-left md:items-start md:flex-row justify-between gap-10 print:gap-4 scroll-mt-32">
          <div className="flex-1 space-y-6 print:space-y-2">
            ...
            <div className="space-y-4 print:space-y-1">
              <img src={cvData.header.logo} alt="ingvar SOLOMA" className="h-24 md:h-32 print:h-16 w-auto object-contain animate-in fade-in slide-in-from-bottom-4 duration-1000 print:hidden dark:invert opacity-80" />
          ...
          <div className="hidden md:block w-64 h-64 print:w-24 print:h-24 relative group">
            ...
            <div className="absolute inset-0 bg-white dark:bg-slate-900 rounded-[3rem] shadow-2xl relative z-10 border border-gray-100 dark:border-slate-800 flex items-center justify-center p-6 print:p-2 transition-all duration-500 group-hover:translate-y-[-8px] print:rounded-xl">
              <img src={cvData.header.favicon} alt="IS Minimalist" className="w-full h-full object-contain" />
            </div>
          </div>
        </header>
